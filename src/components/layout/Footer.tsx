...
export default function Footer() {
  return (
    <footer style={{ background: '#060d18', color: '#475569', padding: '2.5rem 2rem 1.5rem', borderTop: '0.5px solid rgba(255,255,255,0.04)' }}>
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 32, marginBottom: 32 }}>
          ...
          <div>
            <h4 style={{ fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.08em', color: '#1E293B', marginBottom: 10 }}>Elérhetőség</h4>
            <p style={{ fontSize: 13, lineHeight: 1.9 }}>Fecske utca 12.<br />2481 Velence<br />H–P: 8:00–16:00<br />Szo: 8:00–12:00<br />V: Zárva</p>
          </div>
          <div>
            <h4 style={{ fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.08em', color: '#1E293B', marginBottom: 10 }}>Oldalak</h4>
          ...
          <div>
            <h4 style={{ fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.08em', color: '#1E293B', marginBottom: 10 }}>Jogi</h4>
        ...
        <div style={{ borderTop: '0.5px solid #0F172A', paddingTop: 16, fontSize: 12, textAlign: 'center', color: '#1E293B' }}>
